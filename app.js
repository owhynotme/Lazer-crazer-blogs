...
app.get('/test', (req, res) => res.render('test.pug'));
// test
app.get('/howtoplay', (req, res) => res.render('howtoplay.pug'));
app.get('/lazertagparty', (req, res) => res.render('lazertagparty.pug'));
app.get('/lazertagrental', (req, res) => res.render('lazertagrental.pug'));
